...
it("labels and renders a card", () => {
  ...
  expect(html).toContain('<span class="ref-head"><span class="ref-source"><span class="ref-provider">GitLab</span><span class="ref-repo">g/p!9</span><span class="ref-kind">Merge request</span></span></span>');
});
